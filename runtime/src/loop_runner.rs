...
mod tests {
    ...
    fn a_three_turn_dispatch_rests_exactly_twice_between_turns() {
        ...
        let outcome = run_with_sleeper(
            ...
            Some(100), None, None, None, Some(u32::MAX), std::collections::BTreeMap::new(), None, tmp.path(), None, &sleeper,
        )
    ...
    fn a_checkpoint_continuation_does_not_rest_a_second_time() {
        ...
        let outcome = run_with_sleeper(
            &client, &client, "test-model", initial, &tools, &mut traj, false, &cfg,
            Some(100), None, None, Some(40), Some(u32::MAX), std::collections::BTreeMap::new(), None, tmp.path(), None, &sleeper,
        )
    ...
    fn generation_bound_caps_the_request_below_the_answer_bound() {
        ...
        let outcome = run_with_sleeper(
            ...
            std::collections::BTreeMap::new(), None, tmp.path(), None, &RealSleeper,
        )
        .expect(
