...
**v2.10.0** on the [Homebrew tap](https://github.com/kstrat2001/homebrew-darkmux), moving fast: breaking changes ship clean with migration notes, and every release is dogfooded on real work before it tags. Full history: [CHANGELOG.md](CHANGELOG.md).
