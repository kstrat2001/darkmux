...
| **transport** (`http` · `file` · `cmd`) | the *destination and its credentials* | http: one Keychain header value · cmd: the operator's own CLI |
