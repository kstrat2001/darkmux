...
loader keeps rejecting the retired name for forward-compat.
...
Separately, a host-side **inactivity watchdog** kills a container that emits
...
different ports). That's out of scope today; darkmux models a machine as one endpoint,
