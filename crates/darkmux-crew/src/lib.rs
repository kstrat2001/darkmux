...
/// (#1748) The mechanical absence-claim backstop — a text-search lint
/// plus a whole-file check, run against a finding's own "X is missing"
/// claim before that claim reaches a reader unqualified. See the module
