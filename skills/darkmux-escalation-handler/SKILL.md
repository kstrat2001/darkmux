...
- An error string containing one of `escalation_compaction_limit_reached`, `escalation_cumulative_tokens_exceeded`, `escalation_intra_turn_stall_exhausted`, `escalation_generation_checkpoint_budget_exhausted` (#2171), `escalation_malformed_tool_calls` (#2169), or `escalation_empty_tool_calls` (#2190)
